...
## Read the data
df1 = read.csv("C:/User/VK/Desktop/bank.csv", header = T, na.strings = c(" ", "", "NA"))
...
Conf_matrix = table(observed = test[,9], predicted = NB_Predictions)
